...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")  // Permitir CORS en todas las rutas
                ...
                .allowedMethods("GET", "POST", "PUT", "DELETE", "OPTIONS")  // Asegurarse de que OPTIONS está permitido
                .allowedHeaders("*")  // Permitir todos los encabezados
                .allowCredentials(true);  // Permitir credenciales (cookies, headers de autorización)
    }
}
